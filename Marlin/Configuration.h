...
#define STRING_CONFIG_H_AUTHOR "(RepubblicaTech)" // Original author or contributor.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 96.2 } // Stock Ai3M
...
#define INVERT_E0_DIR true    // Creality with Bondtech extruder (and AnyCubic i3 Mega)
